...
settings = {
    ...
    "welcome":"╔══•⊰✯⊱✴❤✴⊰✯⊱•══╗\n\n(◕‿◕✿)สวัสดีสมาชิกใหม่\n\n🙏ยินดีต้อนรับจร้าาา🙏 \n\n(〃･ิ‿･ิ)ゞเข้ามาแล้วก็อย่าดื้ออย่าซนนะ\n(╬◣д◢)ทำตัวน่ารักๆอย่าตบตีกันล่ะ\n(✿ ♥‿♥)เข้ามาแล้วแนะนำตัวเองด้วยนะ\n❤💓💔💕💖💗💙💚💛🧡\n⏰กรุณาปิดแจ้งเตือนด้วยค่าบ⏰\n\n╚══•⊰✯⊱✴❤✴⊰✯⊱•══╝\n      คนหล่อ ŚẾL₣ВΌŦ",
    "kick":"งิเตะทมายยย😂\nMicky🐭🐭 ŚẾL₣ВΌŦ",
    "bye":"╔══•⊰✯⊱✴❤✴⊰✯⊱•══╗\n\nสำหรับฉันมันเพิ่งเริ่มต้น\nแต่สำหรับเธอ\nมันสิ้นสุดลงแล้ว😭😭😭\nลาก่อนเพื่อนรัก🖐🏻🖐🏻🖐🏻 หวังว่าเราคงจะได้พบกันอีกนะ\nMicky🐭🐭 ŚẾL₣ВΌŦ\n\n╚══•⊰✯⊱✴❤✴⊰✯⊱•══╝",
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย แอดมิน Micky🐭🐭 ระบบได้บล็อคคุณอัตโนมัติ!",
    "comment":"""ŚẾL₣ВΌŦ BY:
╔══════════════┓
╠ Micky🐭🐭 ŚẾL₣ВΌŦ
╚══════════════┛""",
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "u3f3acb2be414b688b55a4f9241e7568d"
...
#==============================================================================#
                    ...
                    if targets == []:
                        line.sendMessage(to, "❥ไม่มีคนใส่ล่องหนในกลุ่มนี้ ❋")
                    else:
                        mc = ""
                        for target in targets:
                    ...
                    for g in gs.members:
                        if g.displayName in "":
                            lists.append(g.mid)
                    if lists == []:
                        line.sendMessage(to, "❥ไม่มีmidคนใส่ล่องหนในกลุ่มนี้ ❋")
                    else:
                        mc = ""
                        for mi_d in lists:
                            mc += "->" + mi_d + "\n"
...
#==============================================================================#
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         line.sendMessage(msg.to, "ตั้งข้อความคนคนลบสมาชิกเรียบร้อย")
                     else:
                          settings["kick"] = spl
                          line.sendMessage(msg.to, "Micky🐭🐭 ŚẾL₣ВΌŦ\nตั้งค่าข้อความเมื่อมีคนลบสมาชิกแล้ว\nดังนี้👇\n\n👉{}".format(str(spl)))
...
#==============================================================================#
        ...
        if op.type == 17:
           ...
           if settings["Wc"] == True:
             ...
             line.sendMessage(op.param1, str(settings["welcome"]) +"\n❋สวัสดีคุณ {}, ยินดีต้อนรับเข้าสู่กลุ่ม {}\nมาใหม่แก้ผ้าคร้าบ❋".format(str(dan.displayName),str(tgb.name)))
        ...
        if op.type == 15:
           ...
           if settings["Lv"] == True:
             ...
             dan = line.getContact(op.param2)
             tgb = line.getGroup(op.param1)
             line.sendMessage(op.param1,str(settings["bye"]) + "\nคุณ {}, ได้ออกจากกลุ่ม {} \nเป็นที่เรียบร้อยแล้ว❋".format(str(dan.displayName),str(tgb.name)))
             line.sendContact(op.param1, op.param2)
             line.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net{}".format(dan.picturePath))
        if op.type == 55:
            try:
                if RfuCctv['cyduk'][op.param1]==True:
                    if op.param1 in RfuCctv['point']:
                        ...
                        if Name in RfuCctv['sidermem'][op.param1]:
                            ...
                            pref=['อ้ะๆตาวิเศษเห็นนะ แอบอ่านกันทมายออกมาคุยกัน\n\nMicky🐭🐭Micky🐭🐭']
